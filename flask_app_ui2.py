...
def repaste_after_downshift(holefilled_np, large_mask_np_float, large_image_np, gen_mask_np, large_mask_np, gen_mask_np_float):
    # shift the object in large_image downwards
...
def holefill_and_repaste(large_image_np, gen_image_np, gen_mask_np, large_mask_np):
    ...
    large_mask_np = (large_mask_np_float > 0.).astype(np.float32)  ## NOTE: this is the reason we are shifting objects excessively 
